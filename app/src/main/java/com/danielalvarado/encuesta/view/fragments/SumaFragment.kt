...
class SumaFragment : Fragment() {
    ...
    private fun obtenerResultados(){
        ...
        if (binding.actSuma2.text.toString().toInt() == 40){
            resultado1 += 5
        }
        if (binding.actSuma3.text.toString().toInt() == 20){
            resultado2 += 5
        }
        if (binding.actSuma4.text.toString().toInt() == 40){
            resultado2 += 5
        }
    ...
    private fun lanzarActividad() {
        ...
        bundle.putString("operacion", "sumas")
